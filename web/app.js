...
function summaryView() {
  ...
  app.innerHTML = `
    ...
    <section class="decision-section"><div class="section-heading"><div><p class="kicker">HUMAN-IN-THE-LOOP · SMART FACTORY FIT / 04–05</p><h2>데이터에서 점검 큐로,<br>판단과 기록은 현장으로.</h2></div><p>실제 확장 시 MES·FDC·검사 이력을 FabGuard의 위험순위와 점검예산에 연결합니다. AI는 검토 순서만 제안하고, 엔지니어가 맥락을 확인해 조치와 결과를 기록합니다.</p></div><div class="decision-flow"><article><b>01</b><i>SOURCE & CONTEXT</i><h3>생산 이력 연결</h3><p>Lot·설비·공정·시간 식별자와 MES·FDC 이력을 연결합니다.</p></article><article><b>02</b><i>RISK & BUDGET</i><h3>점검 큐 구성</h3><p>연속 위험점수와 현장 여력을 결합해 상위 점검 범위를 정합니다.</p></article><article><b>03</b><i>HUMAN AUTHORITY</i><h3>엔지니어 판단</h3><p>4M·변동점·품질 이력을 대조하고 재검사·설비점검 여부를 결정합니다.</p></article><article><b>04</b><i>FEEDBACK & AUDIT</i><h3>결과 기록</h3><p>조치·최종 품질·사람의 override를 감사 가능한 기록으로 남깁니다.</p></article></div><div class="design-boundary"><span>DESIGN BOUNDARY</span><p>중요 익명변수는 원인이 아닌 점검 후보입니다. SECOM만으로 4M 범주, 실제 센서, 수율 개선 또는 비용 절감 효과를 규명하지 않습니다.</p></div><div class="implementation-note"><b>CURRENT BOUNDARY</b><p>V1은 공개 SECOM 데이터의 오프라인 위험순위화와 Top-K 점검 큐만 구현했습니다. 실시간 MES/FDC 연동, 생산 제어와 피드백 저장은 목표 구조이며 구현 완료 기능이 아닙니다.</p></div></section>`;
